		...
		<div class="wpcast-welcome">
				...
				<div class="wpcast-welcome__wrapper">
					...
					if( true == $v ) {
						...
						<form class="wpcast-welcome__form" method="post" action="<?php echo admin_url() . 'themes.php?page=wpcast-welcome'; ?>">
							<input type="text" name="wpcastpcode" class="wpcast-pcode" placeholder="<?php esc_html_e('Your purchase code', 'wpcast'); ?>">
			...
			<div class="wpcast-welcome__container">
				<div class="wpcast-welcome__info">
					...
					<ul>
						<li><?php esc_html_e('We will validate your purchase code via Envato API using our server.', 'wpcast'); ?></li>
						<li><?php esc_html_e('We will store your purchase code associated with the actual host.', 'wpcast'); ?></li>
						<li><?php esc_html_e('You can activate this license on unlimited localhost / 127.0.0.1 installations', 'wpcast'); ?></li>
						<li><?php esc_html_e('You can use the same purchse code on multiple subfolders / subdomains as per Envato licensing.', 'wpcast'); ?></li>
						<li><?php esc_html_e("You can't activate the same purchase code on different domains.", 'wpcast'); ?></li>
						<li><?php esc_html_e("We don't store any personal information except domain and purchase code.", 'wpcast'); ?></li>
						<li><?php esc_html_e("You can request the deactivation of your purchase code via email in order to associate it with another domain.", 'wpcast'); ?></li>
